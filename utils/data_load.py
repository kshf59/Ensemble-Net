...
class KittiDataset(Dataset):
    ...
    @staticmethod
    def preprocess(mask_values, pil_img, image_size, scale, is_mask):
        ## image resize ##
        pil_img = pil_img.resize((image_size[1], image_size[0]), resample=Image.NEAREST if is_mask else Image.BICUBIC)
